...
export default function NavContent() {
  return (<div className="nav-content">
    <p>Please note that this app is for revision purposes without the intention to replace a teacher</p>
...
<p><b>On Android</b> click the ⋮ menu button then ‘install app’</p>
